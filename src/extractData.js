...
/**
 * This is the main module starting the data extraction from a starting path and returns and array of objects (found and parsed products).
 * @param {String} homeDir - this is the starting path from which the code will recursively recover each literature-file (all files should be .xml).
